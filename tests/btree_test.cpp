...
namespace
{
    ...
    // TODO: Add test that checks that all pages are not in use after using the BTree.
    ...
    TEST_F(BTreeTest, Startup)
    {
        ...
        BufferManager buffer_manager{page_size, 10};
        BTree<uint64_t, uint64_t> index{834, buffer_manager};
